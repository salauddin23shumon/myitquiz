...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="username" name="username" placeholder="Choose a username" class="form-control input-md" type="username"> 
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="email" name="email" placeholder="Enter emil" class="form-control input-md" type="email" >
  </div>
</div>
<div class="form-group">
...
<div class="form-group">
  <label class="col-md-12 control-label" for="img" style="text-align:center">Upload your iamge</label>
  <input type="file" class="form-control input-md" id="img" name="img" >
</div>
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">About MyITquiz</a></div>
</div>
